...
#if defined(CONFIG_ADSBITSYXB) || defined(CONFIG_ADSVGX) \
	|| defined(CONFIG_ADSBITSYG5)
	smc_init();
#endif
...
#else
int smc9111_eth_send(volatile void *packet, int length) 
#endif
{
